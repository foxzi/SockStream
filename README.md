...
```bash
wget https://github.com/foxzi/SockStream/releases/download/v0.1.5/sockstream_0.1.5_amd64.deb
...
```bash
wget https://github.com/foxzi/SockStream/releases/download/v0.1.5/sockstream-0.1.5-1.x86_64.rpm
