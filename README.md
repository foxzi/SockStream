...
```bash
wget https://github.com/foxzi/SockStream/releases/download/v0.1.6/sockstream_0.1.6_amd64.deb
...
```bash
wget https://github.com/foxzi/SockStream/releases/download/v0.1.6/sockstream-0.1.6-1.x86_64.rpm
