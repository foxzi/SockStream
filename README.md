...
```bash
wget https://github.com/foxzi/SockStream/releases/download/v0.1.2/sockstream_0.1.2_amd64.deb
sudo dpkg -i sockstream_0.1.2_amd64.deb
...
```bash
wget https://github.com/foxzi/SockStream/releases/download/v0.1.2/sockstream-0.1.2-1.x86_64.rpm
sudo rpm -i sockstream-0.1.2-1.x86_64.rpm
sudo systemctl enable --now sockstream
```
